...
public class MediaRecorderNative extends MediaRecorderBase implements MediaRecorder.OnErrorListener {
	...
	public static final String TAG = "recordermedia";
	...
	public void onPreviewFrame(byte[] data, Camera camera) {
		//Log.d(TAG, "onPreviewFrame mRecording:" + mRecording);
	...
	protected void onStartPreviewSuccess() {
		Log.d(TAG, "onStartPreviewSuccess");
